        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <h3 class="text-lg font-semibold mb-4">Add New Exam</h3>
                    ...
                    <form action="{{ route('exam.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-blue-200" placeholder="e.g. Internet Programming Final Exam" required>
                        </div>

                        {{-- Exam description --}}
                        <div class="mb-4">
                            <label class="block text-sm font-medium mb-1">Exam Description</label>
                            <textarea name="description" rows="3" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-blue-200" placeholder="Description"></textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="datetime-local" name="start_at" min="{{ now()->format('Y-m-d\TH:i') }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-blue-200" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="datetime-local" name="end_at" min="{{ now()->format('Y-m-d\TH:i') }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-blue-200" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" min="1" name="duration" min="1" max="300" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-blue-200" placeholder="e.g. 60" required>
                        </div>
