    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- My Classroom Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('student.classroom')" :active="request()->routeIs('student.classroom')">
                        {{ __('My Classroom') }}
                    </x-nav-link>
                </div>
                ...
                <!-- My Classroom Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('student.exam')" :active="request()->routeIs('student.exam')">
                        {{ __('My Exam') }}
                    </x-nav-link>
                </div>
                @endrole
